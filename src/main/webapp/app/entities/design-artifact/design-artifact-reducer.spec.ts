...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESIGNARTIFACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DESIGNARTIFACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DESIGNARTIFACT actions', async () => {
      const arg = { id: 10035 };
    ...
    it('dispatches UPDATE_DESIGNARTIFACT actions', async () => {
      const arg = { id: 10035 };
    ...
    it('dispatches PARTIAL_UPDATE_DESIGNARTIFACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DESIGNARTIFACT actions', async () => {
      const arg = 42666;
