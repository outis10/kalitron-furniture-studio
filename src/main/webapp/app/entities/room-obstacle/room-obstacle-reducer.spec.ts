...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMOBSTACLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOMOBSTACLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOMOBSTACLE actions', async () => {
      const arg = { id: 29223 };
    ...
    it('dispatches UPDATE_ROOMOBSTACLE actions', async () => {
      const arg = { id: 29223 };
    ...
    it('dispatches PARTIAL_UPDATE_ROOMOBSTACLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROOMOBSTACLE actions', async () => {
      const arg = 42666;
