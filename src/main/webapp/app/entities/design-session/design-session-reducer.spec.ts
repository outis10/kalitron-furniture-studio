...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESIGNSESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DESIGNSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DESIGNSESSION actions', async () => {
      const arg = { id: 10438 };
    ...
    it('dispatches UPDATE_DESIGNSESSION actions', async () => {
      const arg = { id: 10438 };
    ...
    it('dispatches PARTIAL_UPDATE_DESIGNSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DESIGNSESSION actions', async () => {
      const arg = 42666;
