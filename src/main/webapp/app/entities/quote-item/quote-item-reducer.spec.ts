...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUOTEITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUOTEITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUOTEITEM actions', async () => {
      const arg = { id: 30045 };
    ...
    it('dispatches UPDATE_QUOTEITEM actions', async () => {
      const arg = { id: 30045 };
    ...
    it('dispatches PARTIAL_UPDATE_QUOTEITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUOTEITEM actions', async () => {
      const arg = 42666;
