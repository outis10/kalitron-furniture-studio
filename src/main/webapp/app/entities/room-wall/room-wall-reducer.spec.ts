...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './room-wall.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMWALL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOMWALL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOMWALL actions', async () => {
      const arg = { id: 122 };
    ...
    it('dispatches UPDATE_ROOMWALL actions', async () => {
      const arg = { id: 122 };
    ...
    it('dispatches PARTIAL_UPDATE_ROOMWALL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROOMWALL actions', async () => {
      const arg = 42666;
