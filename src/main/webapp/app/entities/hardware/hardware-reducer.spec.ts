...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './hardware.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HARDWARE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HARDWARE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HARDWARE actions', async () => {
      const arg = { id: 425 };
    ...
    it('dispatches UPDATE_HARDWARE actions', async () => {
      const arg = { id: 425 };
    ...
    it('dispatches PARTIAL_UPDATE_HARDWARE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HARDWARE actions', async () => {
      const arg = 42666;
