...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CABINETPART_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CABINETPART actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CABINETPART actions', async () => {
      const arg = { id: 27555 };
    ...
    it('dispatches UPDATE_CABINETPART actions', async () => {
      const arg = { id: 27555 };
    ...
    it('dispatches PARTIAL_UPDATE_CABINETPART actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CABINETPART actions', async () => {
      const arg = 42666;
