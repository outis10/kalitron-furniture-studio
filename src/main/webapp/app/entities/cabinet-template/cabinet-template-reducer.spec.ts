...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CABINETTEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CABINETTEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CABINETTEMPLATE actions', async () => {
      const arg = { id: 21622 };
    ...
    it('dispatches UPDATE_CABINETTEMPLATE actions', async () => {
      const arg = { id: 21622 };
    ...
    it('dispatches PARTIAL_UPDATE_CABINETTEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CABINETTEMPLATE actions', async () => {
      const arg = 42666;
