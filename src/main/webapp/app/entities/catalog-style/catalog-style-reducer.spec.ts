...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATALOGSTYLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CATALOGSTYLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CATALOGSTYLE actions', async () => {
      const arg = { id: 23378 };
    ...
    it('dispatches UPDATE_CATALOGSTYLE actions', async () => {
      const arg = { id: 23378 };
    ...
    it('dispatches PARTIAL_UPDATE_CATALOGSTYLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CATALOGSTYLE actions', async () => {
      const arg = 42666;
