...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KITCHENSPEC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KITCHENSPEC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KITCHENSPEC actions', async () => {
      const arg = { id: 11995 };
    ...
    it('dispatches UPDATE_KITCHENSPEC actions', async () => {
      const arg = { id: 11995 };
    ...
    it('dispatches PARTIAL_UPDATE_KITCHENSPEC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KITCHENSPEC actions', async () => {
      const arg = 42666;
