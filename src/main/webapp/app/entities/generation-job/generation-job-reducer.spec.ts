...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERATIONJOB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GENERATIONJOB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GENERATIONJOB actions', async () => {
      const arg = { id: 7565 };
    ...
    it('dispatches UPDATE_GENERATIONJOB actions', async () => {
      const arg = { id: 7565 };
    ...
    it('dispatches PARTIAL_UPDATE_GENERATIONJOB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GENERATIONJOB actions', async () => {
      const arg = 42666;
