...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESIGNIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DESIGNIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DESIGNIMAGE actions', async () => {
      const arg = { id: 29893 };
    ...
    it('dispatches UPDATE_DESIGNIMAGE actions', async () => {
      const arg = { id: 29893 };
    ...
    it('dispatches PARTIAL_UPDATE_DESIGNIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DESIGNIMAGE actions', async () => {
      const arg = 42666;
