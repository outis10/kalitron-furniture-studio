...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATMESSAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHATMESSAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHATMESSAGE actions', async () => {
      const arg = { id: 15525 };
    ...
    it('dispatches UPDATE_CHATMESSAGE actions', async () => {
      const arg = { id: 15525 };
    ...
    it('dispatches PARTIAL_UPDATE_CHATMESSAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHATMESSAGE actions', async () => {
      const arg = 42666;
