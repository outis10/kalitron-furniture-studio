...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    ...
    @Query(
        value = "select chatMessage from ChatMessage chatMessage left join fetch chatMessage.session",
    ...
    @Query("select chatMessage from ChatMessage chatMessage left join fetch chatMessage.session")
    List<ChatMessage> findAllWithToOneRelationships();

    @Query("select chatMessage from ChatMessage chatMessage left join fetch chatMessage.session where chatMessage.id =:id")
