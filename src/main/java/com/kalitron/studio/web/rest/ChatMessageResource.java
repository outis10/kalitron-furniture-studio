...
/**
 * REST controller for managing {@link com.kalitron.studio.domain.ChatMessage}.
 */
@RestController
...
public class ChatMessageResource {
    ...
    /**
     * {@code GET  /chat-messages} : get all the Chat Messages.
     *
     * @param pageable the pagination information.
     * @param eagerload flag to eager load entities from relationships (This is applicable for many-to-many).
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Chat Messages in body.
     */
    @GetMapping("")
